...
const CreateTasks: React.FC = () => {
    ...
    return (
        <div className="p-8 min-h-screen">
            <h1 className="text-3xl text-white font-bold mb-8">Tạo công việc mới</h1>
            <form onSubmit={handleSubmit} className="mt-1 p-6 rounded-lg shadow-md max-w-9xl mx-auto">
                <div className="mb-4">
                    <label className="block font-semibold mb-2 text-white">Tên công việc:</label>
                    <input
                        type="text"
                        value={projectName}
                ...
                <div className="mb-4">
                    <label className="text-white block font-semibold mb-2">Thêm thành viên vào công việc:</label>
                ...
                {members.length > 0 && (
                    <div className="bg-gray-100 p-4 rounded-md">
                        <h3 className="font-semibold mb-2">Danh sách thành viên đã thêm:</h3>
